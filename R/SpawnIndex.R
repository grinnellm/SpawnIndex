...
#'   \code{\link{egg_dens_surf}}, \code{\link{calc_surf_spawn}},
#'   \code{\link{num_eggs_macro}}, \code{\link{calc_macro_spawn}},
#'   \code{\link{egg_dens_under_sub}}, \code{\link{egg_dens_under_alg}}, and
