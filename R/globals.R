utils::globalVariables(
  names = c(
    ...
    "Location_Latitude", "Location_Longitude", "Longitude", "MacroSI", "Mature",
    "Method", "Northings", "Other", "Other_Percent", "Percent_Bottom",
    ...
    "Width_Recorded", "X", "Y", "Year", "algae_coefs", "geometry", "intensity",
    "pars", "regions", "under_width_facs"
  )
)
