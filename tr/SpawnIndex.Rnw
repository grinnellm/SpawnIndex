...
We summarise spawn width by the median because width is not normally distributed \citep{SchweigertEtal1993}.
...
\begin{enumerate}
\item Update $E_{js}$ (i.e., the total number of egg layers) to 2.1496 for the 15 records in the year 1979, Statistical Area 2, and with intensity 4;
