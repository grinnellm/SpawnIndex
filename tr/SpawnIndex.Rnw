...
\begin{enumerate}
\item Update `intensity' from 0 to 1 for 1 record in the year 1962, Statistical Area 14, Section 142, Location code 820, and with $\text{intensity} = 0$.
...
\begin{enumerate}
\item Update $E_{js}$ (i.e., the total number of egg layers) to 2.1496 for 15 records in the year 1979, Statistical Area 2, and with intensity 4;
\item Update $E_{js}$ to 0.5529 for 4 records in the year 1981, Statistical Area 24, and with $E_{js} = 0.0$;
\item Update $E_{js}$ to 1.3360 for 7 records in the year 1982, Statistical Area 23, and with intensity 3;
