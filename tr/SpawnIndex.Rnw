...
advantages include ease of implementation in the field, and
more precision in certain situations;
disadvantages include biased estimators when populations are periodic.
An analogous approach has previously been adopted
to sample commercial fisheries,
