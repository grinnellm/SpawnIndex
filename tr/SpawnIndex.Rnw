...
\begin{enumerate}
\item Update `intensity' from 0 to 1 for the records (1 record) in the year 1962, Statistical Area 14, Section 142, Location code 820, and with $\text{intensity} = 0$.
...
\begin{enumerate}
\item Update $E_{js}$ (i.e., the total number of egg layers) to 2.1496 for the records (15 records) in the year 1979, Statistical Area 2, and with intensity 4;
