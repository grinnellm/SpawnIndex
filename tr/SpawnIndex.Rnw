...
$\omega$ & Female fecundity (Eq \ref{eqECF}). & NC, WCVI, and SoG in 1974 ($n=$ 3,293 fish) and 1980 ($n=$ 1,642); California in 1975 ($n=37$). & $\omega$ ranges from 186.8 to 224.5; SD ranges from 16.9 to 53.5. & \cite{Hay1985, HayBrett1988} \\
