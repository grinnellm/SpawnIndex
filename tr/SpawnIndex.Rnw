...
which is critical spawn index calculations.
...
In addition, we
identify uncertainties in spawn index calculations,
suggest future research to improve spawn index calculations, and
list caveats to using the spawn index in analyses.
...
the resulting time series is a relative index of spawning biomass.}
