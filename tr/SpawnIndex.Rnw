...
In addition, some of these studies had limited number of samples, as well as limited spatial or temporal range, or both.
In addition to work mentioned here and in the previous section, other potential research includes:
\begin{enumerate}
