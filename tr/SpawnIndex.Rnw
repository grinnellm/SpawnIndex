...
Legend: standard error (SE), Strait of Georgia (SoG), West Coast of Vancouver Island (WCVI), North Coast (NC), sample size $n$, standard deviation (SD), and equation (Eq).}
\begin{tabulary}{\linewidth}{LLLLL}
\toprule
Parameter or model & Description & Study details & Uncertainty & Reference \\
\midrule
...
$\omega$ & Female fecundity (Eq \ref{eqECF}). & NC, WCVI, and SoG in 1974 and 1980 ($n$ from 290 to 1,715; total $n=$ 4,935); California in 1975 ($n=37$). & SD from 16.9 to 53.5 & \cite{Hay1985, HayBrett1988} \\
$\phi^f$ & Proportion female (Eq \ref{eqECF}). & & & \\
Eq \ref{eqSurfDensJS} & Surface egg density & ($n=$ 5,111). & & \cite{SchweigertEtal1997} \\
\bottomrule
\end{tabulary}
