...
More recently, surveyors are using satellite imagery to
...
% TODO: Is it worth distinguishing between hierarchical and non-hierarchical
...
we estimate the biomass of \fishName{} that spawned.
% TODO: Not sure this is necessary..
% We use a conversion factor to convert
% the number of observed eggs to
% biomass of fish that produced those eggs.
...
$\mean{\rho}_{xsnry}$ is in $10^3 \cdot \text{eggs} \cdot \text{m}^{-2}$.
% TODO: Use a different symbol, to differentiate the \cdot from the summation
% symbol. Not sure what it should be.
...
print(num_egg_plot)
@
% TODO: Axis labels are faint and should be darker (all figures); same with
...
% TODO: Consider adding a table with spawn index data summary: say, "number of
% egg layers on algae" with min, max, and mean. Do this for each variable shown
% in the figures (6, 7, 8, and 9).
...
% TODO: Why 5% and then 15%? 1 m and then 3 m.. doesn't make sense.
