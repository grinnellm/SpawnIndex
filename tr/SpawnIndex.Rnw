...
This document accompanies our SpawnIndex (\autoref{secDown}) \textbf{R} \citeyearpar[RCT][]{R-4.0.3-32} package.
...
Previously, spawn index calculations were implemented in a \textbf{Microsoft Access} database, and documentation was scattered.
