...
$\omega$ & Female fecundity (Eq \ref{eqECF}). & PRD, WCVI, and SoG in 1974 ($n=$ 3,293 fish) and 1980 ($n=$ 1,642); California in 1975 ($n=37$). & $186.8 \leq \omega \leq 224.5$; $16.9 \leq \text{SD} \leq 53.5$. & \cite{Hay1985, HayBrett1988} \\
...
$\upsilon$ & SOK product weight increase due to brining (proportion; Eq \ref{eqSOKBioFRY}). & SoG ca. 1977. & $11.88 \leq \upsilon \leq 13.37$ for 1.5- to 24-hour brining periods. & \cite{WhyteEnglar1977} \\
