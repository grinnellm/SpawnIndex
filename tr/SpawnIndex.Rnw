...
\begin{enumerate}
\item Check for non-stationarity of fecundity and sex ratios (\autoref{eqECF}),
...
\item Quantify the precision and accuracy of spawn width estimates (e.g., \hyperref[secWidthSurface]{appendix \ref{secWidthSurface}}),
