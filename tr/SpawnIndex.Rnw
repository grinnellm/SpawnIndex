...
\mean{\rho_{{xs}_{nry}}} = \frac{1}{J_{xsnry}} \sum_{j_{xsnry}=1}^{J_{xsnry}} \rho_{j_{xsnry}},
\end{equation}
...
\mean{W_{{xs}_{nry}}} = \frac{1}{T_{xsnry}} \sum_{t_{xsnry}=1}^{T_{xsnry}} W_{t_{xsnry}},
\end{equation}
...
A_{{xs}_{nry}} = \sum_{t_{xsnry}=1}^{T_{xsnry}} A_{t_{xsnry}},
\end{equation}
...
\mean{E_{{xs}_{nry}}} = \frac{1}{T_{xsnry}} \sum_{t_{xsnry}=1}^{T_{xsnry}} \mean{E_{t_{xsnry}}},
\end{equation}
...
\mean{H_{{xs}_{nry}}} = \frac{1}{T_{xsnry}} \sum_{t_{xsnry}=1}^{T_{xsnry}} \mean{H_{t_{xsnry}}},
\end{equation}
...
K_{{xs}_{nry}} = \sum_{t_{xsnry}=1}^{T_{xsnry}} K_{t_{xsnry}},
\end{equation}
...
P_{{xs}_{nry}} = \sum_{t_{xsnry}=1}^{T_{xsnry}} P_{t_{xsnry}},
\end{equation}
...
\mean{\rho_{{xs}_{nry}}} = \frac{\sum_{t_{xsnry}=1}^{T_{xsnry}} \mean{\rho_{t_{xsnry}}} W_{t_{xsnry}}}
...
B_{s_{nry}}' = \sum_{x_{snry}=1}^{X_{snry}} B_{{xs}_{nry}}',
\end{equation}
