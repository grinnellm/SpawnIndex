...
We updated the calculations from a database to an \textbf{R} \citeyearpar[RCT][]{R-4.0.5-32} package for several reasons.
...
We created an \textbf{R} \citeyearpar[RCT][]{R-4.0.5-32} package
...
functions to calculate the spawn index.
