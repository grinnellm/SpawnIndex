...
Therefore, stock assessments exclude spawn data prior to \Sexpr{pars$years$assess}.

While reviewing spawn index calculations and translating them from a \textbf{Microsoft Access} database to \textbf{R},
