...
fig_cap <- paste("Relationship between egg density in thousands of eggs per
                 ...
                 the number of egg layers can exceed those shown in this
                 figure.")
# Expand the values
...
fig_cap <- paste("Relationship between number of eggs in thousands per
                 ...
                 Note that the number of egg layers, plant height, and number of
...
fig_cap <- paste("Relationship between substrate egg density in thousands of
                 ...
                 that the number of egg layers can exceed those shown in this
                 figure.")
# Expand the values
...
fig_cap <- paste("Relationship between algae egg density in thousands of eggs
                 ...
                 \\citep{Schweigert2005}. Note that the number of egg layers can
...
% TODO: Should this be $W''$ to differentiate from understory observed width?
% If yes, make it $W'$ and change understory observed width to $W''$.
