...
\mean{Q_{xsnry}'} = \frac{1}{T_{xsnry}} \sum_{t=1}^{T_{xsnry}} Q_{txsnry}',
\end{equation}
...
\mean{\rho_{snry}} = \frac{1}{T_{xsnry}\mean{Q_{xsnry}'}}\sum_{t=1}^{T_{xsnry}} Q_{txsnry}' \mean{\rho_{txsnry}},
\end{equation}
...
\frac{\left(Q_{txsnry}'\mean{\rho_{txsnry}}-\mean{Q_{snry}'}\mean{\rho_{snry}}\right)^2}
...
\left(\rho_{qtxsnry} - \mean{\rho_{txsnry}}\right)^2,
\end{equation}
