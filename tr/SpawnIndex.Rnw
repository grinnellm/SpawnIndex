...
Nevertheless, \cite{WhyteEnglar1977} determined that following a 24-hour brining period, wet product weight increases by approximately 20\% due to salt uptake.
...
$\nu$ is the proportion of SOK product that is kelp,
$\upsilon$ is the weight increase due to brining as a proportion,
...
$\upsilon$ & Weight increase due to brining (proportion) & \Sexpr{round(pars$SOK$upsilon, digits=4)} & \cite{WhyteEnglar1977} \\
...
$\upsilon$ & Weight increase due to brining (proportion; Eq \ref{eqSOKBioFRY}). & SoG ca. 1977. & NA & \cite{WhyteEnglar1977} \\
