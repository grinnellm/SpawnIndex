...
\end{enumerate}
\item The spawn index is derived data with uncertainty and assumptions, as opposed to observed data (\autoref{secUncertain}), and
...
a second spawn index scaling parameter for the dive survey period $q_2$.
