...
\bottomrule
\endlastfoot
$f^t$, $f^q$ & Transect and quadrat sampling fractions, respectively (Eq \ref{eqStatSigmaS}). & SoG in 1981 and 1983; WCVI in 1982. & Mean egg density $\text{SE}\leq 25$\%. & \cite{SchweigertEtal1985, SchweigertEtal1990} \\
...
$\alpha$, $\beta$ & Parameters for surface egg density (Eq \ref{eqSurfDensJS}). & Coastwide from 1976 to 1987 ($n=$ 5,111). & & \cite{SchweigertEtal1997} \\
$\beta$, $\gamma$, $\delta$, $\epsilon$ & Parameters for number of eggs per Macrocystis plant (Eq \ref{eqMacroEggsPerPlantS}). & HG in 1981 and 1987 ($n=$ 112); PRD in 1986 ($n=$ 15); CC in 1986 ($n=$ 5); WCVI in 1985 and 1986 ($n=$ 35). & Model accounts for 78\% of variation in eggs per plant. & \cite{HaegeleSchweigert1990} \\
$\alpha$ & Parameter for substrate egg density (Eq \ref{eqUnderDensSubQTS}). & SoG in 1976, 1977, and 1978; PRD, CC, and WCVI in 1977. & & \cite{HaegeleHumphreys1976, HaegeleHumphreys1978a, HaegeleHumphreys1978b, HaegeleEtal1979} \\
$\beta$, $\gamma$, $\delta$ & Parameters for algae egg density (Eq \ref{eqUnderDensAlgVQTS}). & Coastwide from 1976 to 1987 ($n=$ 5,111). & Model accounts for 40\% of variation in egg density. & \cite{Schweigert2005} \\
