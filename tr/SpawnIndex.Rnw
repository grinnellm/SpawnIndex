...
et décrivons comment les utilisateurs peuvent installer le paquet R SpawnIndex
pour calculer l'indice de frai en utilisant une base de données d'exemple.
