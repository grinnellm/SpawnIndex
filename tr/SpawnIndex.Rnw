...
$T'$ & Number of potential transects in type $x$, spawn $s$, Location $n$, SAR $r$, and year $y$ & \\
$q$ & Quadrat & 1, 2, 3, ..., $Q$ \\
$Q$ & Number of quadrats in transect $t$, type $x$, spawn $s$, Location $n$, SAR $r$, and year $y$ & \\
$Q'$ & Number of potential quadrats in transect $t$, type $x$, spawn $s$, Location $n$, SAR $r$, and year $y$ & \\
$p$ & Plant & 1, 2, 3, ..., $P$ \\
...
$g$ & SOK fishery & 1, 2, 3, ..., $G$ \\
$G$ & Number of SOK fisheries in SAR $r$ and year $y$ &
