...
surf_spawn <- calc_surf_spawn(
  where = surf_loc, areas = areas, widths = width_bar, yrs = yrRange
)
```
...
# Calculate the Macrocystis spawn index
macro_spawn <- calc_macro_spawn(where = macro_loc, areas = areas, yrs = yrRange)
```
...
# Calculate the understory spawn index
under_spawn <- calc_under_spawn(where = under_loc, areas = areas, yrs = yrRange)
```
