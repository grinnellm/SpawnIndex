...
```{r surf_loc_yr_fig, echo = FALSE, fig.cap = surf_loc_yr_cap}
# Figure caption
...
```{r macro_loc_yr_fig, echo = FALSE, fig.cap = macro_loc_yr_cap}
# Figure caption
...
```{r under_loc_yr_fig, echo = FALSE, fig.cap = under_loc_yr_cap}
# Figure caption
