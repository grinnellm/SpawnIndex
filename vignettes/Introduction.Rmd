...
```{r polygons}
# List indicating the necessary files
sections_loc <- list(
...
stat_areas <- polys$stat_areas
# Grab stat areas and convert
...
ggplot(data = surf_loc_yr) +
  ...
  geom_sf_label(data = polys$stat_areas, mapping = aes(label = StatArea),
                alpha = 0.5) +
