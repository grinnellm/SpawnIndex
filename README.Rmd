...
Thus, convert eggs to biomass in tonnes by
...
Given an area measuring `r length`\ m in length and `r width`\ m in width, 
covered with `r layers` layers of eggs,
there is estimate the number of eggs as 
`r format(eggs, big.mark=",", scientific = FALSE)`, 
in units of 10^3^\ eggs.
Finally, calculate the spawn index (i.e., biomass) in tonnes, t for the spawn.
